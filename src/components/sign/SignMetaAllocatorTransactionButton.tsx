...
export default function SignMetaAllocatorTransactionButton({
  application,
  ...
  const addVerifier = async (verifierAddress: string, datacap: number) => {
    ...
    writeContract({
      ...
      args: [verifierAddress as `0x${string}`, fullDataCap],
    });
  };
            ...
            <Table>
              ...
              <TableBody>
                <TableRow key="to">
                  ...
                  <TableCell>
                    {env.metaAllocatorContractAddress.slice(0, 6)}...
                    {env.metaAllocatorContractAddress.slice(-4)}
                    <a
