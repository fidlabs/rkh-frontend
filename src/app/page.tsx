  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="flex-1">
          ...
          <div className="container px-4 md:px-6 mx-auto">
            <div className="flex flex-col items-center space-y-6 text-center">
              ...
              <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                Apply to become a new Allocator, propose a MetaAllocator and track the progress of
                your process
              </p>
            ...
            <div className="flex flex-col space-y-8 md:space-y-0 md:flex-row md:justify-between md:items-start">
              {[
                ...
                },
                {
                  icon: UserCheckIcon,
                  title: '2. KYC Process',
                  description: 'Complete identity verification checks',
                },
                {
                  icon: UsersIcon,
                  title: '3. Governance Review',
                  description: 'Application assessed by governance team',
                },
                {
                  icon: KeyIcon,
                  title: '4. Final Approval',
                  description: 'Approval by either Root Key Holders or a meta allocator contract',
                },
              ].map((phase, index) => (
                <div
                  key={index}
                  className="flex flex-col items-center text-center max-w-[250px] mx-auto"
                >
        ...
        <section
          id="join-filecoin-plus"
          className="w-full py-20 md:py-32 bg-white dark:bg-gray-800"
        >
          <div className="container px-4 md:px-6 mx-auto">
            <div className="flex flex-col items-center space-y-6 text-center">
        ...
        <div className="container px-4 md:px-6 mx-auto flex flex-col sm:flex-row justify-between items-center">
          ...
          <nav className="flex gap-6">
            <Link
              ...
              href="https://github.com/filecoin-project/Allocator-Registry"
              target="_blank"
              rel="noopener noreferrer"
            >
